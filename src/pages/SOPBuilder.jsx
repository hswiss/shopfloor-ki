  ...
  return (
    <div className="px-4 pt-2 pb-8">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl px-5 py-16 text-center">
        <p className="text-4xl mb-4">{"\u{1F4CB}"}</p>
        <p className="text-zinc-400 text-base">Hier entsteht der SOP Builder</p>
        <p className="text-zinc-500 text-sm mt-2">Arbeitsanweisungen mit KI erstellen</p>
      </div>
    </div>
  );
}
